/*
    ...
    $Id: CVar.h 91 2009-02-25 14:21:04Z gsibley $
...
namespace CVarUtils {
...
#endif
        CVarUtils::CVar<T> *pCVar = new CVarUtils::CVar<T>( s, val, sHelp, true, pSerialisationFuncPtr, pDeserialisationFuncPtr );
   ...
   ////////////////////////////////////////////////////////////////////////////////
    template <class T> T& GetCVarRef( const char* s ) {
        ...
        return *(((CVar<T>*)g_pCVarTrie->Find(s)->m_pNodeData)->m_pVarData);
    }
    ...
    inline std::string GetCVarString( std::string s ) {
        ...
        return
            ((CVar<int>*)g_pCVarTrie->Find(s)->m_pNodeData)->GetValueAsString();
    }
    ...
    template <class T> void SetCVar( const char* s, T val ) {
        ...
        *(((CVar<T>*)g_pCVarTrie->Find(s)->m_pNodeData)->m_pVarData) = val;
    }
    ...
    inline const std::string& GetHelp( const char* s ) {
        ...
        return ((CVar<int>*)g_pCVarTrie->Find(s)->m_pNodeData)->GetHelp();
    }
